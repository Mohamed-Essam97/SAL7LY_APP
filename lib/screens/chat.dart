...
//import 'package:salahli/profile1.dart';
//import 'package:salahli/subcategories.dart';
import 'package:sal7ly_firebase/global/Colors.dart' as myColors;
//import 'package:salahli/categories.dart';
//import 'package:salahli/wensh.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      body: StreamBuilder<QuerySnapshot>(
          stream: Firestore.instance.collection('chat').where("service_owner",isEqualTo: widget.g).snapshots(),
          builder:
...
"https://f...content-available-to-author-only...s.com/v0/b/sal7ly-95e68.appspot.com/o/photo-of-man-changing-tire-of-a-motorcycle-1131221.jpg?alt=media&token=914b0c14-f941-4ba3-bed3-6f312dbc017e"
      ...
      items: [
        ...
        BottomNavigationBarItem(
            icon:SvgPicture.asset(
              "icons/user-avatar-human-admin-login.svg",
              width: 24,
              height: 24,
              color: Colors.grey,
            ),
...
//          data.documents.forEach((doc) {
 ...
 //             print (df.reference.path);
  ...
  Future<Stream> getDataclient() async {
    ...
    streamclients =
        Firestore.instance.collection('service_owner').reference().snapshots();
